using Queue.QueueUsingArray.DataType;

namespace Queue.QueueUsingArray.Example;

public static class Sample
{
    private static readonly QueueDataType QueueDataType = new QueueDataType(10); 
    public static void ExecuteSample()
    {
        Console.WriteLine("Queue Using Array Sample...");
        Insertion();
        Deletion();
